#!/bin/bash
#SBATCH --job-name=vt
#SBATCH --array=0-99               # Job array of 100 jobs (IDs 0–99)
#SBATCH --time=03-00:00:00             # Walltime (hh:mm:ss)
#SBATCH --cpus-per-task=1
#SBATCH --mem=4GB
#SBATCH --partition=submit

outdir="/work/submit/newolfe/tilts-and-kicks/data/vt/snr15/ct-0p8"
initseed=10200
...
$py vt.py \
    ...
    --snr-threshold 15 \
    --seed $seed \
    --extra-kwargs "{\"cos_tilt_min\" : 0.8, \"cos_tilt_max\" : 1}" \
