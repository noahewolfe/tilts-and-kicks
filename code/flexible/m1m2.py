...
parser.add_argument(
    '--parentdir',
    type=str,
    default='../../data/inference/pixelpop/hmc/m1m2'
)
...
if __name__ == '__main__':
    parentdir, name, nbins, maximum_variance, marginalize_sigma = parse_args()
    ...
    probabilistic_model, initial_value = setup_probabilistic_model(
        ...
        maxima={'log_mass_1': np.log(mmax), 'log_mass_2': np.log(mmax)},
