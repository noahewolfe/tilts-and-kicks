...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item precession evolution? -> TODO read papers!
    ...
    \begin{itemize}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.5\linewidth]{./figures/25-11-14/BBH_spin_tilts.png}
            \caption{Caption}
        ...
        \item notes during meeting
        \begin{itemize}
            \item Mike agrees we dont need lots of pop synth
            \item more enlightening to do Monte Carlo study with many different prescriptions for re-alignment, kick distributions \& prescriptions
            \item expand my existing Monte Carlo code with \textit{two} supernovae
            \item if we do find regions that give us peaks away from 1, fold into a population model and run on GWTC-4
            \item total mass or separation on one axis, kick velocity on another, location of peak/lower of HDI90
            \item look at mass slices of tilt angle distribution
        \end{itemize}
    \end{itemize}
    \item Mock Catalog
    \begin{itemize}
    ...
    \item mock catalog notes
    \begin{itemize}
        \item run on CIT
        \item fewer live points, and add on extra parallel chains
